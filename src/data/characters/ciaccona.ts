...
import { ciaccona_BA_3_4_cancel, ciaccona_midair_2_BA_4_cancel, ciaccona_midair_1_2_BA_4_cancel, ciaccona_jump_midair_1_2_BA_4_cancel, ciaccona_skill, ciaccona_liberation, ciaccona_heavy, ciaccona_intro, ciaccona_outro, ciaccona_echo } from '../actions/ciaccona'
import { ciacconaStats } from '../stats/ciaccona'

export const ciaccona: Character = {
  name: 'Ciaccona',
  actions: [ciaccona_BA_3_4_cancel, ciaccona_midair_2_BA_4_cancel, ciaccona_midair_1_2_BA_4_cancel, ciaccona_jump_midair_1_2_BA_4_cancel, ciaccona_skill, ciaccona_liberation, ciaccona_heavy, ciaccona_intro, ciaccona_outro, ciaccona_echo], // TODO
