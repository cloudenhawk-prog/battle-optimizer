      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            {/* Top accent line */}
            <div className="h-px w-full shrink-0" style={{ background: `linear-gradient(90deg, transparent, hsl(${elTheme.primary} / 0.6), transparent)` }} />
                ...
                <div className="flex-1 p-6 flex flex-col">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col xl:flex-row items-start gap-6">
                      ...
                      {/* Set Bonuses */}
                      <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7 }} className="flex-1 min-w-0 space-y-2">
